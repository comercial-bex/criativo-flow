  ...
  const fallbackModules: Module[] = [
    ...
    },
    {
      ...
      items: [
        ...
        { title: "💳 Gestor de Dívidas", url: "/financeiro/gestor-dividas", icon: Icons.CreditCard },
        { title: "📊 DRE", url: "/relatorios/dre", icon: Icons.TrendingUp },
        { title: "⚠️ Inadimplência", url: "/relatorios/inadimplencia", icon: Icons.AlertCircle },
        { title: "💰 Custos por Projeto", url: "/relatorios/custos-projeto", icon: Icons.DollarSign },
        { title: "🗺️ Mapa de Dívidas", url: "/relatorios/mapa-dividas", icon: Icons.Map },
        { title: "💵 Fluxo de Caixa", url: "/relatorios/fluxo-caixa", icon: Icons.TrendingUp },
