        ...
        <ScrollArea className="h-[calc(90vh-120px)] pr-4">
          <form onSubmit={handleSubmit} className="space-y-8">
            ...
            <Card>
              ...
              <CardContent className="space-y-4">
                <div className="space-y-2">
                  <Label>Forças (O que a empresa faz bem)</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  <Label>Fraquezas (O que precisa melhorar)</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  <Label>Oportunidades (Mercado, tendências, expansão)</Label>
                  <Textarea
                ...
                <div className="space-y-2">
                  <Label>Ameaças (Concorrência, economia, fatores externos)</Label>
                  <Textarea
