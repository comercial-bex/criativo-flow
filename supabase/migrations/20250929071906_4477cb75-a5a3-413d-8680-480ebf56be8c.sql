-- Função melhorada para criar usuário cliente com mais flexibilidade
...
BEGIN
    ...
    -- Criar entrada no profiles (simula usuário criado)
    ...
    -- Se foi um UPDATE, pegar o ID existente
    IF NOT FOUND THEN
    ...
    -- Inserir/atualizar na tabela cliente_usuarios
